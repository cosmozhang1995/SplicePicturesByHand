...
private:
    ...
    QPixmap *finalPixmap;
    double globalDrawStartX;
    double globalDrawStartY;
    double globalDrawWidth;
    double globalDrawHeight;
    double finalDrawStartX;
    double finalDrawStartY;
    double finalDrawWidth;
    double finalDrawHeight;
